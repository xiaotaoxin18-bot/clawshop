...
INSERT INTO outbound_record (id, product_id, quantity, operator, warehouse, remark, order_no, out_type, outbound_type, source_warehouse, attachments, items, _created_at, _updated_at, _created_by, _updated_by) VALUES
('out-001', 'prod-001', 50, '张三', '北京主仓库', '客户订单', 'OUT20240223001', 'sales', 'sale', NULL, ARRAY[]::file_attachment[], '[{"productId": "prod-001", "productName": "iPhone 15 Pro", "quantity": 50}]'::jsonb, '2024-02-23T10:00:00Z'::timestamptz, '2024-02-23T10:00:00Z'::timestamptz, NULL, NULL),
('out-002', 'prod-002', 30, '李四', '北京主仓库', '企业采购', 'OUT20240222002', 'sales', 'sale', NULL, ARRAY[]::file_attachment[], '[{"productId": "prod-002", "productName": "MacBook Air M3", "quantity": 30}]'::jsonb, '2024-02-22T14:30:00Z'::timestamptz, '2024-02-22T14:30:00Z'::timestamptz, NULL, NULL),
('out-003', 'prod-003', 60, '王五', '上海分仓', '调拨出库至北京', 'OUT20240221003', 'transfer', 'sale', '上海分仓', ARRAY[]::file_attachment[], '[{"productId": "prod-003", "productName": "AirPods Pro 2", "quantity": 60}]'::jsonb, '2024-02-21T09:00:00Z'::timestamptz, '2024-02-21T09:00:00Z'::timestamptz, NULL, NULL),
('out-004', 'prod-005', 25, '赵六', '深圳保税仓', '线上订单发货', 'OUT20240220004', 'sales', 'sale', NULL, ARRAY[]::file_attachment[], '[{"productId": "prod-005", "productName": "Apple Watch S9", "quantity": 25}]'::jsonb, '2024-02-20T16:00:00Z'::timestamptz, '2024-02-20T16:00:00Z'::timestamptz, NULL, NULL),
('out-005', 'prod-006', 20, '张三', '北京主仓库', '批量销售', 'OUT20240218005', 'sales', 'sale', NULL, ARRAY[]::file_attachment[], '[{"productId": "prod-006", "productName": "无线机械键盘", "quantity": 15}, {"productId": "prod-007", "productName": "4K显示器", "quantity": 5}]'::jsonb, '2024-02-18T11:00:00Z'::timestamptz, '2024-02-18T11:00:00Z'::timestamptz, NULL, NULL),
('out-006', 'prod-009', 40, '李四', '北京主仓库', '促销出货', 'OUT20240215006', 'sales', 'sale', NULL, ARRAY[]::file_attachment[], '[{"productId": "prod-009", "productName": "游戏鼠标", "quantity": 40}]'::jsonb, '2024-02-15T15:00:00Z'::timestamptz, '2024-02-15T15:00:00Z'::timestamptz, NULL, NULL);
...
-- ============================================================
-- Mock数据初始化完成
-- 说明: 此脚本已将真实数据替换为模板测试数据
-- 如需恢复真实数据，请使用 backup_data.sql 中的备份脚本
-- ============================================================
