...
- `color`: `"blue" | "emerald" | "orange" | "red" | "indigo" | "neutral"` - 颜色主题
...
```tsx
// 标准结构：必须同时使用 AlertTitle 和 AlertDescription
...
<Alert>
  ...
  <AlertTitle>需要操作</AlertTitle>
  <AlertDescription>点击按钮完成设置</AlertDescription>
  <AlertAction>
    <Button variant="outline">立即设置</Button>
  </AlertAction>
</Alert>
```
